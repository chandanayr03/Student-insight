...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="studentdashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         ...
         <li><a class="app-menu__item active" href="ViewAssegnment.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">View Assegnment</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">SEARCH ASSEFGMENT HERE!!!</h3>
            <div class="tile-body">
...
$query="SELECT * FROM assignment where branch='$aa' and semester='$a' "; // selecting data through mysql_query()
...
<object data="<?php echo $data['afile']; ?>" type="application/msword" width="600" height="400">
