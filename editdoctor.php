...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="">PATHASALA</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
       ...
       <ul class="app-menu">
        <li><a class="app-menu__item active" href="facultydashboard.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Faculty profile</span></a></li>
