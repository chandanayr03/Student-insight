    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="studentdashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         ...
         <li><a class="app-menu__item active" href="viewevents.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Event</span></a></li>
...
$query="SELECT * FROM event "; // selecting data through mysql_query()
