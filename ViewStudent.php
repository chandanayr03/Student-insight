...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
     ...
     <li><a class="app-menu__item active" href="ViewStudent.php"><i class="app-menu__icon fa fa-plus-square"></i><span class="app-menu__label">View Student</span></a></li>
...
?>
      <div class="clearfix"></div>
        <div class="col-md-12">
          ...
          <form class="row"  action="userdelete.php" method="post"> 
					
					<input  type="hidden" name="p1" value="<?php echo $data['studentid']; ?>"  /></td>
					<td>
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelector(".update-btn").addEventListener("click", function() {
        ...
        window.location.href = "UpdateStudent.php?username=" + encodeURIComponent(username);
    });
});
</script>
