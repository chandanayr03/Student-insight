  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name"><?php echo $_SESSION['username']; ?><?php echo $_SESSION['sid']; ?></p>
...
$query="SELECT * FROM marks WHERE branch='$a' and semester='$b' and studentid='$sid'"; // selecting data through mysql_query()
