...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <form class="row"  action="addattendancedb.php" method="post">
      <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">UPLOAD ATTENDANCE</h3>
            ...
            <div class="form-group">
                    ...
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p4"  value="<?php echo $_SESSION['username']; ?>" readonly >
                  </div>
        ...
        <option value="12">December</option>
            ...
            <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p7" required  placeholder="STUDENT ID" >
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">TOTAL NO OF CLASS</label>
            <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p8" required  placeholder="ENTER TOTAL NO OF CLASS" >
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">NO OF ATTENDED CLASS</label>
            <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p9" required  placeholder="ENTER >NO OF ATTENDED CLASS" >
          </div>
