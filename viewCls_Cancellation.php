    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="studentdashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         ...
         <li><a class="app-menu__item active" href="viewCls_Cancellation.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Class Cancellation</span></a></li>
...
$query="SELECT * FROM cls_cancellation"; // selecting data through mysql_query()
...
<div class="container">
    ...
    <div class="tile">
    <?php if(isset($result)): ?>
        <h2>CLASS CANCELLATION DETAILS:</h2>
        <table border="1">
            <thead>
                <tr>
