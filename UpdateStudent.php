...
?>
      ...
      <div class="row">
		 ...
		 <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Update Student Details</h3>
            <div class="tile-body">
              <form class="form-horizontal" action="editdb1.php" method="post" >
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8"   name="p4" value="<?php echo  $data['studentid'] ?>" placeholder="Enter email address" readonly>
                  </div>
                </div>
                <div class="form-group row">
