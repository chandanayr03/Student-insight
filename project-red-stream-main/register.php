...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO registered_users (name,email,mobile_number,password,blood_group, gender, birth_date, weight, state, zip_code, district, area, landmarks) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    if (!$stmt) {
...
<head>
  ...
  <title>Blood Donation - connect the donors</title>
      ...
      <div class="container">
        <ul class="contact-list">
          ...
          <li class="contact-item">
            ...
            <a href="tel:+917558951351" class="contact-link">+91-9353563324</a>
          </li>
        </ul>
                ...
                <form action="#" method="POST">
                  ...
                  <div class="form-section">
                    ...
                    <div class="form-field">
                      ...
                      <input type="passwosrd" id="password" name="password" required>
                    </div>
                  </div>
                  <!-- Donor Information -->
                  <div class="form-section">
