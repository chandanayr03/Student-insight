      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:blooddonation@gmail.com" class="contact-link">blooddonation@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+919353563324" class="contact-link">+91-9353563324</a>
          </li>
        </ul>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Blood Donation</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
            Blood Donation, Shankarlinge Gowda Road, Mandya<br>
            karnataka, IN<br>
            Pin 571401
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +91 9353563324 | TELEPHONE: 0484-292674<br>
            EMAIL : blooddonation@gmail.com<br>
            </p>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+917052101786" class="footer-link">+91-9353563324</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">blooddonation@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
