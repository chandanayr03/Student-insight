    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="studentdashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         ...
         <li><a class="app-menu__item active" href="ViewAttendance.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Attendance</span></a></li>
...
?>
  ...
  <div class="container">
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <th width="300px">WEEK</th>
                    <th width="300px">TOTAL NO OF CLASS</th>
                    <th width="300px">ATTENDED CLASS</th>
                    <th width="300px">PERCENTAGE </th>
    ...
    while ($data = mysqli_fetch_array($result)) {
        ...
        $percentage = ($data['attended_cls'] / $data['total_cls']) * 100;
        ...
        <tr>
            ...
            <td><?php echo $data['aweek']; ?></td>
            <td><?php echo $data['total_cls']; ?></td>
            <td><?php echo $data['attended_cls']; ?></td>
