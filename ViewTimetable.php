...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="studentdashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         <li><a class="app-menu__item active" href="ViewTimetable.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Timetable</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">SEARCH TIMETABLE HERE!!!</h3>
            <div class="tile-body">
...
$query="SELECT * FROM timetable where branch='$aa' and semester='$a' "; // selecting data through mysql_query()
      ...
      <div class="clearfix"></div>
        <div class="col-md-12">
          <div class="tile">
			...
			<h1>subject: <?php echo $data['about']; ?></h1>

<object data="<?php echo $data['file']; ?>" type="application/msword" width="600" height="400">
