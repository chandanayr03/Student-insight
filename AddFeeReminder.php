...
<li><a class="app-menu__item " href="ViewFaculty.php"><i class="app-menu__icon fa fa-play-circle"></i><span class="app-menu__label">View Faculty</span></a></li>
    ...
    <li><a class="app-menu__item" href="AddaAssignment.php"><i class="app-menu__icon fa fa-calendar-plus-o"></i><span class="app-menu__label">Add Assignment</span></a></li>
        ...
        <li><a class="app-menu__item active" href="AddFeeReminder.php"><i class="app-menu__icon fa fa-trash"></i><span class="app-menu__label">Add Fee Reminder</span></a></li>
    ...
    <main class="app-content">
      ...
      <form action="addfeereminderdb.php" method="post">

      <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">ADD FEE REMINDER</h3>
    ...
    <option value="OTHER">OTHER</option>
            ...
            <label for="exampleInputEmail1">ENTER SUBJECT</label>
              <input class="form-control" name="p3"  type="text" required  placeholder="ENTER SUBJECT">
            </div>
            <div class="form-group ">
            <label for="exampleInputEmail1">ENTER ABOUT SUBJECT</label>
              <input class="form-control" name="p4"  type="text" required  placeholder="ENTER ABOUT SUBJECT">
            </div>
            
            <div class="form-group">
                    <label for="exampleInputEmail1">TOTAL AMOUNT</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p5" required  placeholder="ENTER DATE" >
                  </div>
            <div class="form-group">
                    <label for="exampleInputEmail1">STUDENT ID</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p6" required placeholder="Enter Student ID" >
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">FIRST INSTALLMENT AMOUNT</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p7" required  placeholder="ENTER DATE" >
                  </div>
            <div class="form-group">
                    <label for="exampleInputEmail1">FIRST INSTALLMENT DUE DATE</label>
                    <input class="form-control" type="DATE" aria-describedby="emailHelp" name="p8" required placeholder="Enter Student ID" >
                  </div>
           
                  <div class="form-group">
                    <label for="exampleInputEmail1">SECOND INSTALLMENT AMOUNT</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p9" required  placeholder="ENTER DATE" >
                  </div>
            <div class="form-group">
                    <label for="exampleInputEmail1">SECOND INSTALLMENT DUE DATE</label>
                    <input class="form-control" type="DATE" aria-describedby="emailHelp" name="p10" required placeholder="Enter Student ID" >
                  </div>
