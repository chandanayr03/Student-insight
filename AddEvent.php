...
<li><a class="app-menu__item " href="ViewFaculty.php"><i class="app-menu__icon fa fa-play-circle"></i><span class="app-menu__label">View Faculty</span></a></li>
    ...
    <li><a class="app-menu__item" href="AddaAssignment.php"><i class="app-menu__icon fa fa-calendar-plus-o"></i><span class="app-menu__label">Add Assignment</span></a></li>
        ...
        <li><a class="app-menu__item active" href="AddEvent.php"><i class="app-menu__icon fa fa-trash"></i><span class="app-menu__label">Add Event</span></a></li>
      ...
      <div class="col-md-6">
          <div class="tile">
            ...
            <div class="form-group">
                    ...
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p1"  required  placeholder="ENTER SUBJECT" >
                  </div>
            
            <div class="form-group ">
            <label for="exampleInputEmail1">ENTER ABOUT EVENT</label>
              <input class="form-control" name="p2"  type="text" required  placeholder="ENTER ABOUT EVENT">
            </div>      
            <div class="form-group">
                    <label for="exampleInputEmail1">DATE</label>
                    <input class="form-control" type="DATE" aria-describedby="emailHelp" name="p3" required  >
                  </div>
