...
$target_file = $target_dir . basename($_FILES["p3"]["name"]); // Path of the uploaded file
$uploadOk = 1;
...
$sql = "INSERT INTO timetable (branch, semester, file, about) 
        VALUES ( '$a', '$b', '$target_file','$d')";
...
if (mysqli_query($con, $sql)) {
    ...
    <script type="text/javascript">
        ...
        window.location="AddaTimetable.php";
    </script>
    <?php
} else {
