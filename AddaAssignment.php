...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <li><a class="app-menu__item active" href="AddaAssignment.php"><i class="app-menu__icon fa fa-calendar-plus-o"></i><span class="app-menu__label">Add Assignment</span></a></li>
      ...
      <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">UPLOAD ASSIGNMENT DETAILS</h3>
    ...
    <option value="OTHER">OTHER</option>
            ...
            <div class="form-group">
                    ...
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" value="<?php echo $_SESSION['username']; ?>" name="p4" required readonly >
                  </div>
            ...
            <label for="exampleInputEmail1">VIDEO</label>
              <input class="form-control" name="p5"  type="file" required  placeholder="Select FILE">
            </div>
            <div class="form-group ">
            <label for="exampleInputEmail1">SUBMISSTION DATE</label>
              <input class="form-control" name="p6"  type="date" required  placeholder="Select Date">
            </div>
