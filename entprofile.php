...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="studentdashboard.php"><i class="fa fa-user fa-lg"></i> Profile</a></li>
            <li><a class="dropdown-item" href="enterlogout.php"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
			 <li><a class="dropdown-item" href="studenteditdash.php"><i class="fa fa-sign-out fa-lg"></i> Update Profile</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="entprofile.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Student Dashborad</span></a></li>
         <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Video Class</span></a></li>
         <li><a class="app-menu__item active" href="entprofile.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">View Notes</span></a></li>
         <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Marks</span></a></li>
         <li><a class="app-menu__item active" href="entprofile.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">View Attendance</span></a></li>
         <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">QNA</span></a></li>
         <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">QNA</span></a></li>
         <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">QNA</span></a></li>
