...
<html lang="en">
  ...
  <?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `facultyprofile` WHERE facultyid='$username' and password='$password'";
		...
		<script type="text/javascript">
			...
			<?php 
				...
				echo "<div class='form'><h3>Username/password is incorrect.</h3><br/>Click here to <a href='facultylogin.php'>Login</a></div>";
				}
    }else{
...
<form action="" method="post" name="facultylogin">
