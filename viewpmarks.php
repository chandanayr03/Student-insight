    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="dashboard.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Perent Dashborad</span></a></li>
         <li><a class="app-menu__item active" href="viewpmarks.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Marks</span></a></li>
         <li><a class="app-menu__item " href="ViewpAttendance.php"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">View Attendance</span></a></li>
...
$query="SELECT * FROM marks WHERE branch='$a' and semester='$b' and s_id='$sid'"; // selecting data through mysql_query()
