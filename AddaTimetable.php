...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <li><a class="app-menu__item" href="AddaAssignment.php"><i class="app-menu__icon fa fa-calendar-plus-o"></i><span class="app-menu__label">Add Assignment</span></a></li>
        ...
        <li><a class="app-menu__item active" href="AddaTimetable.php"><i class="app-menu__icon fa fa-calendar-plus-o"></i><span class="app-menu__label">Add Timetable</span></a></li>
    ...
    <main class="app-content">
      ...
      <form action="addtimetabledb.php" method="post"  enctype="multipart/form-data">

      <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">UPLOAD TIMETABLE </h3>
    ...
    <option value="OTHER">OTHER</option>
            ...
            <option value="OTHER">OTHER</option>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="p3"  type="file" required  placeholder="Select FILE">
                  </div>
                  <div class="form-group">
                    <label for="exampleTextarea">ABOUT</label>
                    <input class="form-control" name="p4"  type="text" required  placeholder="Select FILE">
                  </div>
