...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
     ...
     <li><a class="app-menu__item active" href="AddFaculty.php"><i class="app-menu__icon fa fa-play-circle"></i><span class="app-menu__label">Add Faculty</span></a></li>
      ...
      <div class="row">
		 ...
		 <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="form-horizontal" action="facultyprofile.php" method="post">
    ...
    <option value="OTHER">OTHER</option>
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="p4" type="number" maxlength="13" placeholder="Enter phone number" required >
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">FACULTY ID</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="p5" type="text" placeholder="Enter Username" require >
                  </div>
                </div>
				<div class="form-group row">
                  <label class="control-label col-md-3">PASSWORD</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="p10" type="text" placeholder="Enter Password" require >
                  </div>
                </div>
                <div class="form-group row" >
  ...
  <option value="biology">Biology</option> 
          ...
          <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="p9" style="text-transform:uppercase" type="text" placeholder="Enter Email" required >
                  </div>
                </div>
