    ...
    <div class="col-md-6">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">ASK FEEDBACK</h3>
              
            </div>
            <div class="form-group">
                    <label for="exampleInputEmail1">FACULTY ID</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p1" required placeholder="Enter Faculty ID" >
                  </div>
            ...
            <div class="form-group ">
            <label for="exampleInputEmail1">ENTER FEEDBACK</label>
              <input class="form-control" name="p5"  type="text" required  placeholder="ENTER QUESTION">
            </div>
